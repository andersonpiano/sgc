...
class Ion_auth
{
    ...
    public function __construct()
    {
        ...
        if ($this->config->item('use_ci_email', 'ion_auth')
            && isset($email_config) && is_array($email_config)
        ) {
            ...
            if ($user) {
                ...
                if (!$this->config->item('use_ci_email', 'ion_auth')) {
                    ...
                    $message = $this->load->view(
                        $this->config->item('email_templates', 'ion_auth') .
                        $this->config->item('email_forgot_password', 'ion_auth'), $data, true
                    );
                    $this->email->clear();
                    $this->email->from(
                    ...
                    $this->email->subject(
                        $this->config->item('site_title', 'ion_auth') .
                        ' - ' . $this->lang->line('email_forgotten_password_subject')
                    );
    ...
    public function logged_in()
    {
        ...
        if (!$recheck && get_cookie($this->config->item('identity_cookie_name', 'ion_auth'))
