    ...
    <div class="container">
        ...
        <div id="tab_folhas" class="tab-pane">
            <div class="container-fluid">
                ...
                <a id="btn_add_categoria" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Nova Folha</i></a>
                ...
                <div class="modal-body">
                    <form id="form_evento">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                    <!--<?php //echo form_dropdown($tipo_evento_select);?>-->
                                        <input type="radio" id="credito" name="tipo_evento" value="C">
                                        <label for="male">&nbsp;&nbsp;Crédito&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                        <input type="radio" id="debito" name="tipo_evento" value="D">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                    <!--<?php //echo form_dropdown($tipo_evento_select);?>-->
                                        <input type="radio" id="sim" name="evento_fixo" value="C">
                                        <label for="male">&nbsp;&nbsp;Sim&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                        <input type="radio" id="nao" name="evento_fixo" value="D">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                        <input type="radio" id="sim" name="evento_percentual" value="C">
                                        <label for="male">&nbsp;&nbsp;Sim&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                        <input type="radio" id="nao" name="evento_percentual" value="D">
                                        <label for="female">&nbsp;&nbsp;Não</label><br>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Eventos a Incidir</label>
                            <div class="col-lg-10">
                            <input type = "checkbox" id = "incidir" nome = "subscribe" value = "IR">
                            <label for = "incidir">&nbsp;&nbsp;IR&nbsp;&nbsp;</label>
                            <input type = "checkbox" id = "incidir" nome = "subscribe" value = "INSS">
                            <label for = "incidir">&nbsp;&nbsp;INSS&nbsp;&nbsp;</label>
