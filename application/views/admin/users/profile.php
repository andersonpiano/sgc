                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo lang('users_box_title');?></h3>
                                </div>
                                <div class="box-body">
...
<?php foreach ($user_info as $user):?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo($user->created_on != 0 ? date('d/m/Y H:i:s', $user->created_on) : 'Sem informação'); ?></td>
                                            </tr>
                                            <tr>
                                                <th><?php echo lang('users_last_login'); ?></th>
                                                <td><?php echo(!empty($user->last_login) ? date('d/m/Y H:i:s', $user->last_login) : 'Nunca acessou o sistema'); ?></td>
                                            </tr>
                                            <tr>
...
<?php endforeach?>
                                            ...
                                            <tr>
                                                <th><?php echo lang('actions_change_password'); ?></th>
                                                <td><?php echo anchor('auth/changepassword', lang('actions_change_password'), array('class' => 'btn btn-default btn-flat')); ?></td>
                                            </tr>
<?php endforeach;?>
                                        </tbody>
                                    </table>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Setores vinculados</h3>
                                </div>
                                <div class="box-body">
