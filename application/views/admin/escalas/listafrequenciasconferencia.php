                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="dontprint">
                                                    ...
                                                    <?php echo(($tipo_batida_escala != "OK" && $tipo_batida_escala != "Vago" && $freq->status != 1) ? anchor('admin/escalas/aguardarjustificativa/'.$freq->id, lang('actions_justificativa'), array('class' => 'btn btn-primary btn-flat', 'target' => '_blank', 'title' => 'Aguardar justificativa')) . '&nbsp;' : ''); ?>
                                                    <?php echo(($tipo_batida_escala != "OK" && $tipo_batida_escala != "Falta" && $tipo_batida_escala != "Vago" && $freq->status != 1) ? anchor('admin/escalas/registrarfalta/'.$freq->id, lang('actions_falta'), array('class' => 'btn btn-primary btn-flat', 'target' => '_blank', 'title' => 'Registrar falta')) . '&nbsp;' : ''); ?>
