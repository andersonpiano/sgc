...
<?php foreach ($plantoes as $plantao):?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($plantao->duracao . 'h', ENT_QUOTES, 'UTF-8'); ?></td>
                                                <td>
...
<?php foreach ($recebidos as $recebido) :?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($recebido->duracao . 'h', ENT_QUOTES, 'UTF-8'); ?></td>
...
<?php foreach ($passagens as $passagem):?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($passagem->duracao . 'h', ENT_QUOTES, 'UTF-8'); ?></td>
                                                ...
                                                <td><?php echo htmlspecialchars($statuspassagem[$passagem->statuspassagem], ENT_QUOTES, 'UTF-8'); ?></td>
                                                <td>
