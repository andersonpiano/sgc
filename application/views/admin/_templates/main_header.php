...
?>
            <header class="main-header">
                <a href="<?php echo site_url('admin/dashboard'); ?>" class="logo">
                    <span class="logo-mini"><b>SG</b><?php echo $title_mini; ?></span>
                    <span class="logo-lg"><b>SG</b><?php echo $title_lg; ?></span>
                </a>
...
<?php if ($admin_prefs['user_menu'] == TRUE): ?>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url($avatar_dir . '/generic.png'); ?>" class="user-image" alt="User Image">
