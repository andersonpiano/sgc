                        ...
                        <div class="col-md-12">
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo lang('residentes_edit'); ?></h3>
                                </div>
                                <div class="box-body">
                                    <?php echo form_open(uri_string(), array('class' => 'form-horizontal', 'id' => 'form-edit_residentes')); ?>
...
<?php if ($this->ion_auth->is_admin()): ?>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="checkbox">
                                                    <label>
    <?php $checked = ($residente->active == 1) ? 'checked' : '';?>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <?php echo anchor('admin/residentes/createuser/' . $residente->id, lang('actions_create_user'), array('class' => 'btn btn-default btn-flat')); ?>
                                                    <?php echo anchor('admin/residentes/linktounit/' . $residente->id, lang('actions_link_user_sector'), array('class' => 'btn btn-default btn-flat')); ?>
                                                </div>
                                            </div>
                                        </div>
                                    <?php echo form_close();?>
