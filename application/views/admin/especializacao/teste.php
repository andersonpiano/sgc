    ...
    <?php if ($tipoescala['value'] == 0) : ?>
        ...
        <?php foreach ($meus_plantoes as $plantao):?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo anchor('admin/justificativas/create/index.php?'.'plantao_id='.$plantao->id.'&setor_id='.$plantao->setor_id.'&profissional_id='.'&data_plantao='.$plantao->dataplantao.'&hora_in='.$plantao->horainicialplantao.'&hora_out='.$plantao->horafinalplantao, lang('actions_justificativa'), 'class="btn btn-primary"'); ?> &nbsp;
