                        ...
                        <div class="col-md-12">
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo lang('funcionarios_find'); ?></h3>
                                </div>
                                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">
                                        <?php echo anchor('admin/funcionarios/create', '<i class="fa fa-plus"></i> '. 
                                            lang('funcionarios_create'), 
                                    ...
                                    <table class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="dontprint"><?php echo lang('funcionarios_action');?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
<?php foreach ($funcionarios as $prof):?>
                                            <tr>
                                                ...
                                                <td class="dontprint text-center">
                                                    <?php echo anchor('admin/funcionarios/view/'.$prof->id, lang('actions_see'), array('class' => 'btn btn-primary btn-flat')); ?> &nbsp;
                                                    <?php echo anchor('admin/funcionarios/edit/'.$prof->id, lang('actions_edit'), array('class' => 'btn btn-default btn-flat')); ?> &nbsp;
                                                    <?php echo anchor('admin/funcionarios/linktosector/'.$prof->id, lang('actions_link_user_sector'), array('class' => 'btn btn-default btn-flat')); ?>
                                                </td>
                                            </tr>
<?php endforeach;?>
                                        </tbody>
